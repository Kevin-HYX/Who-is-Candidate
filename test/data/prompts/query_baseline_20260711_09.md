...
| "Has worked in healthcare finance" | `{"dimension":"domain_search_text","text":"Work in healthcare finance.","weight":1.2}` | `{"dimension":"domain_search_text","text":"Handle patient billing, insurance claims, revenue cycle, reimbursement, and healthcare compliance.","weight":1.2}` | Healthcare finance does not authorize guessed child processes. Add them only when the user names them. |
